...
public class ProductoRestController extends HttpServlet        
{
            ...
            throws ServletException, IOException
    {
        ...
        //ServicioProductoSinglenton.getInstancia().modificar(producto);
        ServicioProductoSinglenton spa = ServicioProductoSinglenton.getInstancia();
        spa.modificar(producto);
